...
class ImageStorageManager
{
    ...
    {
        // $this->getDisk() ?? $this->setDisk('ckeditor');  // Ensure the disk is 'ckeditor'

        //set properties
        $this->getFileDirectory() ?? $this->setFileDirectory(
        ...
        $this->getFileName() ?? $this->setFileName(Str::uuid()->toString());
