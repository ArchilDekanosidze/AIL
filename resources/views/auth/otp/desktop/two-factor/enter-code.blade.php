...
@section('head-tag')
<title>تایید کد فعال سازی احراز هویت دو مرحله ای</title>
@endsection
...
<section class="">
    <section id="main-body-two-col" class="container-xxl body-container">
        ...
        @endif
            ...
            <form method="POST" action="{{route('auth.otp.desktop.setting.two.factor.code')}}">
                        @csrf
                        ...
                        <a class="small ml-2" href="{{route('auth.otp.desktop.setting.two.factor.resend')}}">@lang('public.didNotGetCode')</a>
                        </div>
                        @error('code')
