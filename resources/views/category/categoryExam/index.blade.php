...
@section('style')
<link rel="stylesheet" href="{{ asset('assets/css/category/categoryExam/index.css') }}">
@endsection
...
<script>
    $(document).ready(function () {
        ...
        selectors.on('change', function () {
            ...
            if (selectedId) {
                $.get('/categories/categoryExam/children/' + selectedId, function (data) {
        ...
        function loadCategories(parentId, $select) {
            $.get('/categories/categoryExam/children/' + parentId, function (data) {
        ...
        function fetchBooks(page = 1) {
            ...
            const url = "{{ route('category.categoryExam.getExam') }}" + "?page=" + page;
        ...
        $(document).on('click', '#pagination-wrapper a', function (e) {
            ...
            const result = Ajax("{{ route('category.categoryExam.getExam') }}", data, "GET");
