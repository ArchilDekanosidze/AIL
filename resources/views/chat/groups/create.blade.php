...
<div class="CategoryBook main-body">
    <div class="mainDivDirection">
        <div class="chat-create-form-box">
            ...
            <form action="{{ route('chat.groups.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <label>
                        <input type="radio" name="is_private" value="0" checked> خصوصی
                    </label>
                    <label class="ml-4">
                        <input type="radio" name="is_private" value="1"> عمومی
                    </label>
                </div>
                ...
                <div class="form-group mb-4"> 
                    <label for="avatar" class="form-label font-semibold">تصویر نمایه (اختیاری)</label>
                    <input type="file" name="avatar" id="avatar" accept="image/*" class="form-control w-full p-2 rounded border">
                    <small class="text-gray-500">فقط تصاویر (JPEG, PNG, WEBP) تا حداکثر 2MB</small>
                </div>
